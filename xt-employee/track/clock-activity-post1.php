                        ...
                        <div class="x_panel">
                            ...
                            if(isset($_REQUEST["acc"]))
                            {
                                if(getA("acc")=="ing")
                                {
                                    ...
                                    ?>
                                        <script>
                                            document.location.href = 'clock-registered1.php?tipo=In';
                                        </script>
                                    <?php
                                    }
                                    else
...
/*
                            ...
                            <form action="clock-activity-post1.php?acc=ing" method="post" name="forma" id="forma" enctype="multipart/form-data">
                                   ...
                                   /* $rs = $post -> obtener($db,$text);
                                    ...
                                    if ($rs) 
                                    {
                                        ...
                                        <div class="col-md-6 col-xs-12 bg-map">
                                            ...
                                            <h4>Post Info</h4>
                                                <label for="">Post: </label> <?php echo $text ?><br>
                                                <label for="">Address: </label> <?php echo $dir ?><br>
                                                <label for="">Date Time: </label> <?php echo $date ?>

                                            <input type="hidden" name="co_post" id="co_post" value="<?php echo $text ?>">    
                                            </div>
                                        </div>
